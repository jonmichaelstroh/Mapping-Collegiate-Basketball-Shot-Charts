...
trice_shots_2020_test <- trice_shots_2020 %>% mutate(loc_x = if_else(loc_x == 25 & loc_y == 5.25, loc_x + runif(1, min = -1, max = 1), loc_x))

trice_shots_2020_test
```
