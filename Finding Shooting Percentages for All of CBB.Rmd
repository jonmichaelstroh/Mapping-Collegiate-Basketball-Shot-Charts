...
big_ten_shot_quadrants_players
```
...
view(big_ten_shot_data_quadrant1_players)
```
...
round(quantile(big_ten_shot_data_quadrant1_players$shooting_percent, c(.2, .4, .6, .8)), digits = 0)
```
